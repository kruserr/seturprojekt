...
\begin{lstlisting}[title={raspberrypi/ui/styles/Home.module.css}, language=JavaScript]
.container {
  min-height: 100vh;
  padding: 0 0.5rem;
  display: flex;
